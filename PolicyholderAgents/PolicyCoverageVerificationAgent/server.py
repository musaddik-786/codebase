...
# Port: 7707
# MCP : http://localhost:7720/api/v1/policy_coverage/mcp
...
# MCP_URL = os.getenv("MCP_URL", "http://localhost:7720/api/v1/policy_coverage/mcp")
# AGENT_PORT = int(os.getenv("AGENT_PORT", "7707"))
...
Port: 8807
MCP : http://localhost:8800/api/v1/policy_coverage/mcp
