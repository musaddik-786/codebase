...
Port: 7703
MCP : http://localhost:7720/api/v1/segmentation/mcp
...
MCP_URL = os.getenv("MCP_URL", "http://localhost:7720/api/v1/segmentation/mcp")
AGENT_PORT = int(os.getenv("AGENT_PORT", "7703"))
